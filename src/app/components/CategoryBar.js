...
export default function CategoryBar({ active, onChange }) {
  return (
    <div className="sticky top-0 z-30 bg-white/80 dark:bg-[#0f1710]/90 backdrop-blur-md border-b border-stone-200 dark:border-emerald-900/40 shadow-sm">
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`shrink-0 inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-150 cursor-pointer
                  ${
                    isActive
                      ? "bg-emerald-600 text-white shadow-sm shadow-emerald-500/20"
                      : "text-stone-600 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-emerald-900/20 hover:text-stone-900 dark:hover:text-stone-200"
                  }`}
              >
                {config.icon}
                {config.label}
